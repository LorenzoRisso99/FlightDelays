...
public class ExtFlightDelaysDAO {
	...
	public void loadAllAirports(Map<Integer,Airport> idMap) {          //Passiamo la mappa   --> tormiamo il void quindi sto metodo 
		String sql = "SELECT * FROM airports";                                       //  serve solo per riempire mappa per model  --> togliamo ritorni
	...
	public List<Airport> getVertici(int x, Map<Integer,Airport> idMap) {
		...
		try {
			...
			while (rs.next()) {
				...
				result.add(idMap.get(rs.getInt("id")));   //prendo id che mi arriva in query come chiave mappa e lo uso per trovare aereoporto e ritornarlo in lista 
